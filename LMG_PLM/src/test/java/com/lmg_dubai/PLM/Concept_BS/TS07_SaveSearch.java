...
public class TS07_SaveSearch extends BaseLib {
	@Test
	public void ts01() throws Exception {
		...
		init.plmTechSpecPage.clickOnSaveSearch();
		init.plmTechSpecPage.navigateToSaveSearchPopUp("CS"+ System.currentTimeMillis());
