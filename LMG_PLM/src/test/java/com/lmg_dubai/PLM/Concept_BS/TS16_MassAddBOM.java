...
public class TS16_MassAddBOM extends BaseLib {
...
//		init.plmHomePage.clickOnNavigationDashboardTextOption("Tech Spec");
		...
		init.plmTechSpecPage.SelectAddBOMAction("BOM Actions");
		init.plmTechSpecPage.SelectAddcomponentAction("Add Component");
		init.plmTechSpecPage.AddNewComponent();
