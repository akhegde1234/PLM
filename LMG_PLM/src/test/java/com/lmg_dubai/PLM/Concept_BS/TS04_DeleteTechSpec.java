...
public class TS04_DeleteTechSpec extends BaseLib {
...
//		init.plmHomePage.clickOnNavigationDashboardTextOption("Tech Spec");
		...
		init.plmLoginPage.loginToPLM("Login_Cred_PLM", 4, 1, 5, 1);
		init.plmHomePage.clickOnNavigationDashboardTextOption("Tech Spec");
		...
		init.plmTechSpecPage.SelectDeleteAction("Delete Actions");
